...
-- Create trigger to log changes to the `inventory` table
CREATE OR REPLACE FUNCTION public.log_inventory_changes()
    RETURNS TRIGGER AS
$BODY$
BEGIN
    IF TG_OP = 'DELETE' THEN
        INSERT INTO public.audit_log (audit_action, audit_table, item_id)
...
CREATE OR REPLACE TRIGGER inventory_changes_trigger
